...
public class CustomerView extends ImageView {
	 ...
	 */
	private CustomerView(String label, String image, int xPos, int yPos){
	 ...
	 */
	public static CustomerView create(String label, String image, int xPos, int yPos){
	
		return new CustomerView(label, image, xPos, yPos);
